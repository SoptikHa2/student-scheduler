        ...
        main: function Main () {
            ...
            StudentScheduler.App.Gid("test").onclick = function (e) {
                ...
                */
                ...
                StudentScheduler.App.plan.teachers.add(new StudentScheduler.AppLogic.User("Teacher", System.Array.init([true, true, true, true, true], System.Boolean), System.Array.init([600, 600, 600, 600, 600], System.Int32), System.Array.init([1080, 1080, 1080, 1080, 1080], System.Int32)));
                // Generate 30 students
                var rnd = new System.Random.ctor();
                for (var i3 = 0; i3 < 30; i3 = (i3 + 1) | 0) {
                    var timesFrom = System.Array.init([rnd.next$2(600, 900), rnd.next$2(600, 900), rnd.next$2(600, 900), rnd.next$2(600, 900), rnd.next$2(600, 900)], System.Int32);
                    var timesTo = System.Array.init([rnd.next$2(720, 1080), rnd.next$2(720, 1080), rnd.next$2(720, 1080), rnd.next$2(720, 1080), rnd.next$2(720, 1080)], System.Int32);
                    StudentScheduler.App.plan.students.add(new StudentScheduler.AppLogic.User("Student " + i3, System.Array.init([true, true, true, true, true], System.Boolean), timesFrom, timesTo));
                }
